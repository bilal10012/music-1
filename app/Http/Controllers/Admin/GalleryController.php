...
class GalleryController extends Controller //its for Resource Portion
{
    ...
    public function update(Request $request, Gallery $gallery)
    {
        ...
        $gallery->button_text =  $request->button_text;
        $gallery->button_link =  $request->button_link;
        $gallery->save();
        Session::flash('success', 'Event Image Has Been Updated Successfully!');
        return redirect()->route('admin.gallery.index');
    }
