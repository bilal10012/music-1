...
@section('content')
    <div class="content">
        <h2 class="content-heading">Adding new Blog <a href="{{route('admin.blog.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" name="title" placeholder="Blog Name" value="{{old('title')}}">
                                    @if($errors->has('title'))
                            ...
                            <div class="row gutters-tiny items-push">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        ...
                                        <label class="custom-file-label">Choose Blog's Display Image</label>
                                    </div>
