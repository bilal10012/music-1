...
@section('title', 'Updating Blog - '.$blog_detail->title)
@section('before-css')
...
@section('content')
    <div class="content">
        <h2 class="content-heading">Blog #{{$blog_detail->id}} ({{$blog_detail->name}}) <a href="{{route('admin.blog.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
        <form method="post" action="{{route('admin.blog.update', $blog_detail->id)}}" enctype="multipart/form-data">
            <div class="row gutters-tiny">
                    ...
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="name" name="title" placeholder="title" value="{{(old('title'))?old('title'):$blog_detail->title}}">
                                    @if($errors->has('title'))
                            ...
                            <div class="form-group row">
                                <label class="col-12">Author Name</label>
                                <div class="col-12">
                                    <input type="text" class="form-control" id="name" name="author" placeholder="author" value="{{(old('author'))?old('author'):$blog_detail->author}}">
                                    @if($errors->has('author'))
                                        <div class="text-danger ml-5 font-weight-bold">{{ $errors->first('author') }}</div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="block-content block-content-full p-0">
                                        ...
                                        <textarea name="description" class="js-summernote"style="height:300px;" value="{{(old('description'))?old('description'):$blog_detail->description}}">{{(old('description'))?old('description'):$blog_detail->description}}</textarea>
                ...
                <div class="col-md-4">
                            <div class="block block-rounded block-themed">
                              <div class="block-header bg-gd-primary">
                              <h3 class="block-title">Blog Image</h3>
                            </div>
                            <div class="block-content block-content-full">
                                <div class="row gutters-tiny items-push">
                                <img src="{{asset($blog_detail->primary_image)}}" class="img-fluid m-auto p-20" style="max-height: 200px;">
                            ...
                            <div class="block-content block-content-full">
                                <div class="row gutters-tiny items-push">
                                <img src="{{asset($blog_detail->inner_image)}}" class="img-fluid m-auto p-20" style="max-height: 200px;">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                ...
                                <div class="row gutters-tiny items-push">
                                <img src="{{asset($blog_detail->author_image)}}" class="img-fluid m-auto p-20" style="max-height: 200px;">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        <input type="file" class="custom-file-input" accept="image/*" name="author_image" data-toggle="custom-file-input">
                                        <label class="custom-file-label">Change Author's Image</label>
                                    </div>
                                    @if($errors->has('author_image'))
                                        <div class="text-danger ml-5 font-weight-bold">{{ $errors->first('author_image') }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                            ...
                            <!-- <div class="block block-rounded block-themed">
                              <div class="block-header bg-gd-primary">
                              <h3 class="block-title">Blog Inner Image</h3>
                            </div>
                            <div class="block-content block-content-full">
                                <div class="row gutters-tiny items-push">
                                <img src="{{asset($blog_detail->inner_image)}}" class="img-fluid m-auto p-20" style="max-height: 200px;">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        <input type="file" class="custom-file-input" accept="image/*" name="inner_image" data-toggle="custom-file-input">
                                        <label class="custom-file-label">Change Blog's Detail Image</label>
                                    </div>
                                    @if($errors->has('inner_image'))
                                        <div class="text-danger ml-5 font-weight-bold">{{ $errors->first('inner_image') }}</div>
                                    @endif
                            ...
                            <div class="form-group row text-center">
                                ...
                                <div class="col-12">
                                    <label class="css-control css-control-success css-switch">
                                        <input type="checkbox" class="css-control-input" value="checked" name="is_active" {{($blog_detail->is_active == 1)? 'checked': ''}}>
