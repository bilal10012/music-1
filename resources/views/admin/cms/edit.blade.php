                    ...
                    @foreach ($contents as $content)
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @endif
                                @if ($content->video_2 != null)
                                    <div class="form-group row  mt-20">
                                        <label class="col-12">Video 2</label>
                                        <video src="{{ asset($content->video_2) }}" autoplay class="img-fluid"
                                            controls></video>
                                        <div class="col-12 mt-10">
                                            <input type="file" name="content[{{ $content->id }}][video_2]">
                                        </div>
                                    </div>
                                @endif
                            </div>
