...
@section('content')
    <main id="main-container">
        <div class="bg-image bg-image-bottom mt-30"
            style="background-image: url({{ asset('storage/images/profile-bg.jpg') }});">
                ...
                <div class="block-content">
                    <form action="{{ route('admin.profileUpdate', auth()->user()->id) }}" method="POST"
                        ...
                        <div class="row items-push">
                            <div class="col-lg-3">
                                <p class="text-muted">
                                    Your account’s vital info. Your full name, username and profile image will be publicly
                                    visible.
                                    @csrf
                                </p>
                            </div>
                            <div class="col-lg-7 offset-lg-1">
                                    ...
                                    <div class="col-md-10 col-xl-6 text-center">
                                        ...
                                        <div class="custom-file text-left">
                                            <input type="file" class="custom-file-input" id="profile-settings-avatar"
                                                name="profile_image" data-toggle="custom-file-input">
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="f_name"
                                            placeholder="Your First Name" value="{{ auth()->user()->name(1) }}">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="l_name"
                                            placeholder="Your Last Name" value="{{ auth()->user()->name(2) }}">
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="username"
                                            placeholder="Your Username" value="{{ auth()->user()->username }}">
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="address_1"
                                            placeholder="Your Address" value="{{ auth()->user()->address_1 }}">
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <input type="email" class="form-control form-control-lg disabled" name="email"
                                            placeholder="Your Email Address" value="{{ auth()->user()->email }}" disabled
                                            title="You cannot change your Email Address">
                                    </div>
                                    <div class="col-6">
                                        <label for="profile-settings-name">Contact Number</label>
                                        <input type="tel" class="form-control form-control-lg Phone" name="contact"
                                            placeholder="Your Contact Number" value="{{ auth()->user()->contact }}">
                                ...
                                <div class="form-group row">
                                    <div class="col-12 position-relative">
                                        ...
                                        <input type="password" class="form-control form-control-lg"
                                            id="profile-settings-password" name="current_password">
                                        <i class="fas fa-eye toggle-password"
                                            data-target="#profile-settings-password"></i>
                                    </div>
                                </div>
                                @csrf
                                <div class="form-group row">
                                    <div class="col-12 position-relative">
                                        ...
                                        <i class="fas fa-eye toggle-password"
                                            data-target="#profile-settings-password-new"></i>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12 position-relative">
                                        ...
                                        <i class="fas fa-eye toggle-password"
                                            data-target="#profile-settings-password-new-confirm"></i>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                id="profile-settings-company" name="profile-settings-company">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                id="profile-settings-firstname" name="profile-settings-firstname">
                                        </div>
                                        <div class="col-6">
                                            <label for="profile-settings-lastname">Lastname</label>
                                            <input type="text" class="form-control form-control-lg"
                                                id="profile-settings-lastname" name="profile-settings-lastname">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                id="profile-settings-street-1" name="profile-settings-street-1">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                id="profile-settings-street-2" name="profile-settings-street-2">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                id="profile-settings-city" name="profile-settings-city">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                id="profile-settings-postal" name="profile-settings-postal">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                id="profile-settings-vat" name="profile-settings-vat" value="IA00000000"
                                                disabled="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
