                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    <div class="form-material form-material-primary floating mt-20">
                                        <input type="text" id="button-text" class="form-control" name="button_text">
                                        <label for="button-text">Button Text</label>
                                    </div>
                                </div>
                                {{-- <div class="col-md-3">
                                    <div class="form-material form-material-primary floating mt-20">
                                        <input id="button-color" type="text" class="js-colorpicker form-control" name="button_color" data-format="hex">
                                        <label for="button-color">Button Color</label>
                                    </div>
                                </div> --}}
                                <div class="col-md-5">
                                    <div class="form-material form-material-primary floating mt-20">
                                        <input id="button-link" type="text" class="form-control" name="button_link">
                            ...
                            <div class="row gutters-tiny items-push">
                                <div class="col-sm-12 col-xl-12">
                                    <div class="block">
                                        ...
                                        <label class="custom-file-label">Choose Banner Image</label>
                                    </div>
