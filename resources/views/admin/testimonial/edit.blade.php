...
@section('content')
    <div class="content">
        <h2 class="content-heading">testimonial #{{$testimonial_detail->id}} ({{$testimonial_detail->name}}) <a href="{{route('admin.testimonial.index')}}" class="btn btn-alt-primary pull-right">Back</a></h2>
            ...
            <div class="row gutters-tiny">
                <div class="col-md-10">
                    <div class="block block-rounded block-themed">
                        ...
                        <div class="block-content block-content-full">
                            <div class="form-group row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control" id="name" name="title" placeholder="title" value="{{(old('title'))?old('title'):$testimonial_detail->name}}">
                                    @if($errors->has('title'))
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control" name="role" placeholder="Manager" value="{{(old('role'))?old('role'):$testimonial_detail->designation}}">
                            @if($errors->has('role'))
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <div class="block-content block-content-full p-0">
                                <label>Review of the Customer</label>
                                <textarea name="description" style="width: 100%; height: 100px">{{ old('description')?old('description'):$testimonial_detail->review }}</textarea>
                            ...
                            <div class="col-md-8">
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label for="display">Display on Home Page (Only 4 will be displayed; the least recent will be replaced by this)</label>
                                        <div class="form-check">
                                            <input type="checkbox" name="display" id="display" value="1" class="form-check-input"
                                                {{ old('display', $testimonial_detail->display) ? 'checked' : '' }}>
                            ...
                            <div class="block-content block-content-full">
                                ...
                                <img src="{{asset($testimonial_detail->image)}}" class="img-fluid m-auto p-20" style="max-height: 200px;">
